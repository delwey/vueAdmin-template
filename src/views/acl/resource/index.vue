  ...
  <imp-panel>
    ...
    <el-row slot="body" :gutter="24" style="margin-bottom: 20px;">
      <el-col :span="6" :xs="24" :sm="24" :md="6" :lg="6" style="margin-bottom: 20px;">
        <el-tree v-if="resourceTree" ref="resourceTree" :data="resourceTree" highlight-current clearable :render-content="renderContent" @node-click="handleNodeClick" node-key="resourceId" :props="defaultProps">
        </el-tree>
      </el-col>
          ...
          <div class="text item">
            <el-form :model="form" ref="form" :rules="rules">
              ...
              <el-form-item label="类型" :label-width="formLabelWidth">
                ...
                <el-radio class="radio" v-model="form.type" :label=3>目录</el-radio>
              </el-form-item>
            ...
            <div class="select-tree">
              <el-scrollbar tag="div" class='is-empty' wrap-class="el-select-dropdown__wrap" view-class="el-select-dropdown__list">
                <div class="icons-wrapper">
                  ...
                  <i class="fa fa-clipboard" @click="selectIcon($event)"></i>
                  ...
                  <i class="fa fa-user-o" @click="selectIcon($event)"></i>
...
import { getTree, add, update, remove } from '@/api/acl/resource'
  ...
  methods: {
    ...
    newAdd() {
      ...
      this.options.splice(0, 1, {
        value: this.selectedNode.resourceId,
      ...
      this.form = {
        ...
        icon: '',
        sort: 0,
        parentId: this.selectedNode.resourceId
      }
    },
    initRoot() {
      this.isUpdate = false
      this.options.splice(0, 1, { value: '0000', label: '资源' }) // 替换当前选项
      this.form = {
        resourceId: null,
        name: '',
        href: '',
    ...
    deleteSelected() {
      this.$confirm('确定删除?', '提示', {
        ...
        remove(this.form.resourceId).then(res => {
          this.deleteFromTree(this.resourceTree, this.form.resourceId, 'resourceId')
          this.initRoot()
        })
      })
    },
    onSubmit() {
      if (this.isUpdate) {
        update(this.form).then(res => {
          this.updateTreeNode(this.resourceTree, res.data, 'resourceId')
        })
      } else {
        add(this.form).then(res => {
          this.appendTreeNode(this.resourceTree, res.data, 'resourceId', 'parentId')
        })
      }
    }
  },

<template>
  <div class="el-select" v-clickoutside="handleClose">
    ...
    <el-input ref="reference" v-model="selectedLabel" type="text" :placeholder="currentPlaceholder" :name="name" :size="size" :disabled="disabled" :readonly="multiple" :validate-event="false" @focus="visible = true" @click="handleIconClick" @mouseenter.native="inputHovering = true" @mouseleave.native="inputHovering = false" :icon="iconClass">
    </el-input>
